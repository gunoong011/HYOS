...
‘진정한 프로그래머’라는 별명은 1980년 직후까지도 없었다.
그러면, 도대체 이 '진정한 프로그래머'란 누구를 칭하는 것일까?
에릭 레이먼드의 입장에서 그들이 누구를 칭하는 것인지 오픈소스의 역사를 통해 생각해보길 바란다.
...
![Tiny brick](./https://github.com/SonMinWoo/HYOS/blob/master/TinyBrickEvalBrd.jpg)
...
1180 Alvarado SE, 114, Albuquerque, New Mexico, 87108 주소의 제 이름으로 보내주시면 됩니다. 저에게 열 명의 프로그래머를 고용해서 취미 (컴퓨터) 시장에 좋은 소프트웨어를 아낼 수 있게 해주신다면 그 것보다 행복한 일이 없을 것입니다.
